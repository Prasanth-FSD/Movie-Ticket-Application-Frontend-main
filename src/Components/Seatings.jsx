...
const Seatings = () => {
    ...
    const fetchBookings = async () => {
        try {
           ...
           // let res = await axios.get("http://localhost:8500/bookings/getAllBookings", {
            let res = await axios.get("https://movie-ticket-application-backend-main.onrender.com/bookings/getAllBookings", {
                params: {
                    email,
                    theaterName,
                    date,
    ...
    const handleBooking = async () => {
        try {
            let { theaterName, date, movieName, time } = bookingDetails;
           // let resp = await axios.post("http://localhost:8500/bookings/updateBookings", {
            let resp = await axios.post("https://movie-ticket-application-backend-main.onrender.com/bookings/updateBookings", {
                email,
                theaterName,
                date,
                movieName,
